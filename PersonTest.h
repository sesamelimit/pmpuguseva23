...
#include <string>
using namespace std;
const int quan[] = { 1,2,3,5,14,9,13,13,7,9,10,10,6,12,6,6,10,7,12,11,6,9,7,8,7,7,6,11,13,10,12,11,6,13,14,7,12,14,10,9,8,6,7,8,8,9,6,6,8,13 };
...
public:
    PersonTest();
    PersonTest(std::string n, int i, std::vector<double> result);
    void read_c();
    void read_f(string filename);
    void write();
    //выводит -1 если this меньше pt2; 0 если равны; 1 если больше
